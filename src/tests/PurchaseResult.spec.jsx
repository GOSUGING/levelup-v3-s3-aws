...
describe('PurchaseResult', () => {
  ...
  it('renderiza encabezado y estado de carga', async () => {
    ...
    expect(screen.getByText(/Compra realizada con éxito/i)).toBeInTheDocument()
    expect(screen.getByText(/Cargando.../i)).toBeInTheDocument()
    await screen.findByText(/Confirmación:/i)
  })
  ...
  it('muestra datos de pago e items del payload', async () => {
    ...
    expect(await screen.findByText(/Confirmación:/i)).toBeInTheDocument()
